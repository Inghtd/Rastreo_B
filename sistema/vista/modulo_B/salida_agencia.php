...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Cuadre de Despacho para agencias.
...
$(document).ready(function(){
  ...
  $.ajax({
          url : '../sistema/prg/selects/info_bolsa.php?f=1',
          dataType: "text",
          success : function(data){
                    var str = JSON.parse(data);
                    console.log(str);

                   $("#test>tbody").append("<tr><td>"+ str.Ingreso +"/"+str.Arribo+"</td></h3></tr>");
 ...
 function contador(){
  $.ajax({
          ...
          success : function(data){
                    ...
                    console.log(str);
                    $("#test>tbody").html('');
                   $("#test>tbody").append("<tr><h3><td>"+ str.Ingreso+"/"+str.Salida_agencia+"</td></h3></tr>");
                  //adding row to end and start
                  //$("#test>tbody").prepend("<tr><td>Test Row Prepend</td></tr>");
                }
              }
